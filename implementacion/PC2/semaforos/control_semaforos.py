...
# Cada intersección tiene DOS semáforos:
#   FILA    → controla el tráfico horizontal (a lo largo de la fila / calle)
#   CARRERA → controla el tráfico vertical   (a lo largo de la columna / carrera)
# Siempre deben estar en estados opuestos.
semaforos = {
    inter: {
...
# ── Ciclo automático por intersección ────────────────────────────────────────
...
# ── Procesamiento de comandos de la analítica ─────────────────────────────────
        ...
        with lock_sem:
            for inter in via:
                if inter in semaforos:
                    ...
                    semaforos[inter]["CARRERA"]     = "VERDE"   # ola verde: ambos verde
